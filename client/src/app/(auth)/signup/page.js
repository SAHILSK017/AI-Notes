          ...
          <div>
            ...
            <div className="max-w-md animate-in fade-in slide-in-from-left-8 duration-1000">
              <h1 className="text-6xl font-extrabold leading-[1.1] text-foreground mb-6 tracking-tight">
                Your journey to <span className="text-primary">clarity</span> starts here.
              </h1>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="mb-8">
                  ...
                  <p className="text-muted-foreground/50 text-sm font-medium">Join our mindful workspace.</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-muted-foreground/45 uppercase tracking-[0.1em] ml-1">Full Name</label>
                    <div className="relative group/input">
                      <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <User className="h-5 w-5 text-muted-foreground/30 group-focus-within/input:text-primary transition-colors" />
                      </div>
                      <input
                        type="text"
