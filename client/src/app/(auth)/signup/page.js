          ...
          <div>
            ...
            <div className="max-w-md animate-in fade-in slide-in-from-left-8 duration-1000">
              <h1 className="text-6xl font-extrabold leading-[1.1] text-white mb-6 tracking-tight">
                Your journey to <span className="text-[#d6a96d]">clarity</span> starts here.
              </h1>
              <p className="text-xl text-[#f3f1ea]/70 leading-relaxed font-medium">
                Join a community of thinkers and writers using AI to organize their world.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#16181d] p-10 rounded-[2.5rem] border border-[#23262d] shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="mb-8">
                ...
                <p className="text-[#f3f1ea]/50 text-sm font-medium">Join our mindful workspace.</p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-[#f3f1ea]/40 uppercase tracking-[0.1em] ml-1">Full Name</label>
                  <div className="relative group/input">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                      <User className="h-5 w-5 text-[#f3f1ea]/20 group-focus-within/input:text-[#d6a96d] transition-colors" />
                    </div>
                    <input
                      type="text"
              ...
              <div className="mt-8 pt-8 border-t border-[#23262d] text-center">
                <p className="text-sm text-[#f3f1ea]/40 font-medium">
                  Already part of our space?{' '}
                  <Link href="/login" className="text-[#d6a96d] hover:text-[#e5b97d] font-bold transition-colors underline-offset-4 hover:underline">
                    Sign in here
                  </Link>
                </p>
              </div>
